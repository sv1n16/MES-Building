...
def temperature_below_lower_rule(model, b, t):
    """Slack variable for temperature below lower deadband"""
    return model.T_below_lower[b, t] >= model.T_lower_bound[b, t] - model.T_in[b, t]


model.temperature_below_lower = pyo.Constraint(model.buildings, model.t, rule=temperature_below_lower_rule)


def temperature_above_upper_rule(model, b, t):
    """Slack variable for temperature above upper deadband"""
    return model.T_above_upper[b, t] >= model.T_in[b, t] - model.T_upper_bound[b, t]


model.temperature_above_upper = pyo.Constraint(model.buildings, model.t, rule=temperature_above_upper_rule)
