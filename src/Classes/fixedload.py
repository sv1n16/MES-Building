...
class FixedLoad():
    ...
    def __init__(self, start_point,time_horizon,method=0, demand=0, annual_demand=0, profile_type="H0", single_family_house=True,
        ...
        p = self.loadcurve[start_point:start_point+time_horizon] / 1000
